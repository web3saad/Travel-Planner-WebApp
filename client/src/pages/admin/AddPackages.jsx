...
const AddPackages = () => {
  ...
  const storeImage = async (file) => {
    return new Promise((resolve, reject) => {
      try {
        console.log("Starting server-side image upload for file:", file.name, "Size:", file.size, "bytes");
        ...
        // Use fetch or axios to upload to our backend
        ...
        setImageUploadError(`Unexpected error: ${error.message}`);
        reject(error);
      }
    });
  };
